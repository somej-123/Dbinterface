...
/*
 *    MyBatis 는 XML 또는 @SelectProvider 를 이용해서 동적 SQL 을 처리함.
...
public class SampleSelectProvider {
	...
	/*
	 *  메서드의 파라미터는 2개 이상의 데이터를 던질 수 있도록 
	 *  Map<String, Object> 로 설정함.
	 */
	public static String searchUname(Map<String, Object> params){
		
		String strSql = "select username from member where 1 =1 ";
		
		if(params.get("type").equals("userid")){
			strSql += " and userid = #{keyword}";//#{uid} 변경
		}
